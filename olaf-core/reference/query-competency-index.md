...
**Last Updated:** 20251112-1243 CEDT
**Collection:** all
...
- **Name:** all
- **Competencies Included:** prompt-engineer, common, business-analyst, developer, git-assistant, olaf-specific-tools, project-manager
- **Total Entry Points:** 66
...
[
  ...
  [{"merge competency pack to main", "merge pack to main", "add competency to main", "integrate competency pack", "merge competency"}, "olaf-specific-tools/prompts/merge-competency-pack-to-main.md", "Act"]
