...
/**
 * Service for interacting with GitHub API to fetch OLAF releases and bundles
 */
export class GitHubService {
    ...
    private constructor() {
        ...
        if (this.usePrivateRepo && !this.token && !this.useGitHubCli) {
            this.logger.warn('Private repository access enabled but no GitHub token provided and GitHub CLI is disabled. Please set olaf.githubToken in settings or enable olaf.useGitHubCli.');
        }
